...
3. 使用 Grep/Glob 在项目中搜索**所有 Mussel 3 模式**，检查以下类别：
   - **组件标签**：`<mu-editor`、`<mu-option`、`<mu-tabs-buttons`、`<mu-tree-view`、`<mu-tree-node`、`<mu-tree-nodes`、`<mu-dropdown-item`、`<mu-dropdown-check-item`、`<mu-dropdown-radio-item`
   - **废弃属性**：`mask-action`、`:moveable`、`:clear-button`、`dropdown-align`、`sticky-target`、`reserve-icon-place`、`trigger-action`、`:tab-bar-params`
   ...
   - **废弃 CSS 类**：`.mu-bg-transparent`、`.mu-bg-white`、`.mu-bg-black`、`.mu-bg-x-color`
