<template>
  <div>
    ...
    <div class="p-2x">
      <mu-form class="border border-primary" label-width="60px" label-align="right">
        ...
        <hr>
        <mu-form-row>
          <mu-form-field class="flex-1" label="Text 3" error="Text 3 不正确">
            <mu-input value="Value 3" />
          </mu-form-field>
          <mu-form-field class="flex-1" label="Text 4" error>
            <mu-input input-style="underline" value="Value 4" />
          </mu-form-field>
          <mu-form-field class="flex-1" label="Text 5" error>
        ...
        <mu-form-field label="Text 7" error="shit">
