  ...
  <div class="bg-normal flex flex-wrap items-start gap-2x p-2x" style="width: 100%">
    ...
    <div v-if="!demo || demo === 4" class="demo-panel">
      ...
      <mu-tree
        :data="data"
        :active-node="activeNode"
        :node-icons="{ folder: 'ok', folderOpen: 'ok', leaf: 'alien' }"
        @node-click="onNodeClick" />
    </div>
    <div v-if="!demo || demo === 5" class="demo-panel">
      ...
      <mu-tree
        ...
        :node-icons="{ folder: 'lock', folderOpen: 'lockOpen', leaf: 'calendar' }"
        @node-click="onNodeClick" />
    </div>
    ...
    <div v-if="!demo || demo === 9" class="demo-panel">
      <h3>
        9. Auto Expand Level
        <mu-button @click="expandTree.expandAll()">
          Expand All
        </mu-button>
        <mu-button @click="expandTree.collapseAll()">
          Collapse All
        </mu-button>
      </h3>
      <mu-tree
    ...
    <div v-if="!demo || demo === 10" class="demo-panel">
      <h3>
        10. Expand Nodes
        <mu-button @click="expandToActive">
          Expand To Active
        </mu-button>
        <mu-button @click="expandNodes">
          Expand Random
        </mu-button>
        <mu-button @click="expandTree2.collapseAll()">
          Collapse All
        </mu-button>
      </h3>
      <mu-tree
    ...
    <div v-if="!demo || demo === 13" class="demo-panel">
      <h3>
        ...
        <mu-button @click="checkedNodesKeys.clear()">
          Uncheck All
        </mu-button>
      </h3>
      <mu-tree
