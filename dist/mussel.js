  ...
  */
  ...
  var __vue_render__$6 = function __vue_render__() {
    ...
    return _c("span", {
      ...
      attrs: {
        type: _vm.buttonType || "icon",
        icon: _vm.icon
      },
      on: {
        click: _vm.onClick
      }
    }, [!_vm.iconClass ? _c("mu-icon", {
      attrs: {
        icon: _vm.icon
      }
    }) : _vm._e()], 1);
  ...
  var InputButton = normalizeComponent_1({
